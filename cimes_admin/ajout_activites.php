...
<meta name="description" content="Formulaire d'ajout d'une activité">
...
<body>
    ...
    <div class="form-wrapper">
        <h1 class="form-page-title">Ajout d'une activité</h1>
        <p class="form-page-sub">Remplissez les champs ci-dessous pour ajouter une nouvelle activité.</p>
