...
<title>Ajout d'un logo partenaire</title>
<meta name="description" content="Formulaire d'ajout d'un logo partenaire">
...
<body>
    ...
    <div class="form-wrapper">
        <h1 class="form-page-title">Ajouter un logo partenaire</h1>
        <p class="form-page-sub">Importez le logo et renseignez son texte alternatif.</p>

        <div class="form-card">
            <p class="form-card__title"><i class="fa-solid fa-image"></i> Logo</p>
            <div class="form-group">
                <label>Fichier logo <span style="color:var(--red);">*</span></label>
                <label class="upload-zone" for="logo_file">
                    ...
                    <div class="upload-info">
                        <strong>Cliquez pour importer un logo</strong>
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                <label for="alt_text">Texte alternatif (alt) <span style="color:var(--red);">*</span></label>
                <input type="text" id="alt_text" class="form-control" placeholder="ex: CNRS, Région Occitanie...">
            </div>
        </div>

        <div class="form-actions">
            <a href="dynam_logo_partenaire.php" class="btn-cancel">Annuler</a>
            <button id="envoyer" class="btn-submit"><i class="fa-solid fa-floppy-disk"></i> Créer le logo</button>
        </div>
        <div id="erreur" class="alerte"></div>
    </div>

    <script>
        let lien = 'cree_logo_partenaire';
