...
<title>Ajout d'une mission</title>
<meta name="description" content="Formulaire d'ajout d'une mission du CIMES">
...
<body>
    ...
    <div class="form-wrapper">
        <h1 class="form-page-title">Ajout d'une mission</h1>
        <p class="form-page-sub">Remplissez les champs ci-dessous pour créer une nouvelle mission du CIMES.</p>
    ...
    <script>
        /* ── variable attendue par creer_modif_mission.js ── */
        let lien = 'cree_mission';
        ...
        /* ─── Exposer les données pour creer_modif_mission.js ─── */
