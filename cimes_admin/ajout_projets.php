...
<meta name="description" content="Formulaire d'ajout d'un projet de recherche CIMES">
...
<body>
    ...
    <div class="form-wrapper">
        <h1 class="form-page-title">Ajout de projet</h1>
        <p class="form-page-sub">Remplissez les champs puis enregistrez.</p>
        ...
        <div class="form-card">
            ...
            <div class="form-actions" style="display:flex; justify-content:flex-end; gap:12px; margin-top:8px;">
                ...
                <a href="#" class="btn-submit" id="envoyer" style="opacity:1; pointer-events:auto;">
