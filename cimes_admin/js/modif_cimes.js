document.title = `Modifier dans le CIMeS`;
...
console.log('Parent ID:', parentId);
        ...
        if (data === "ok") {
            document.querySelector("#erreur").innerHTML = `
                ...
                <a href="dynam.php?id=${parentId}" class="bouton_ajouter">Revenir à la page de gestion du CIMeS</a>
            `;
        } else {
