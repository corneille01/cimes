...
<meta name="description" content="Formulaire d'ajout d'un contact">
...
<body>
    ...
    <div class="form-wrapper">
        <h1 class="form-page-title">Ajout d'un contact</h1>
        <p class="form-page-sub">Remplissez les champs ci-dessous pour créer un nouveau contact.</p>
