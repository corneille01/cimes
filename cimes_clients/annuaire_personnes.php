...
<meta name="description" content="Annuaire des membres et collaborateurs">
...
<body>
    ...
    <section class="annuaire-hero">
        <div class="annuaire-hero__inner">
            <h1><strong>Annuaire des membres</strong></h1>
            <p class="annuaire-hero__sub">Retrouvez les membres, chercheurs et collaborateurs du réseau.</p>
        </div>
    </section>
    ...
    <section class="annuaire-grid" id="annuaire" aria-label="Liste des membres">
        <div class="loader">
    ...
    <script src="js/code_annuaire.js"></script>
