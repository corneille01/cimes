...
<head>
    <meta charset="UTF-8">
    <title>Mes recherches sur la montagne</title>
...
<body>
    ...
    <section class="ajouter">
        <h1>Mes recherches sur la montagne</h1>
        <a href="ajoute_recherche_user.php" id="ajoutPub" class="bouton_ajouter"> Ajouter une recherche</a>
    </section>
    ...
    <section class="panneau_supp" id="panneausup">
        <p class="texte_supp">Etes-vous certain de vouloir supprimer ?</p>
        <div class="btn_supp">
    ...
    <script src="js/mes_recherches.js" async defer></script>
</body>
