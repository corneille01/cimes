...
if ($id_projet <= 0) {
    header("Location: user_dynam_projets.php");
    exit;
}
?>
...
<meta name="description" content="Formulaire de modification d'un projet - espace utilisateur">
...
<body>
    ...
    <div class="form-wrapper">
        <h1 class="form-page-title">Modifier votre projet</h1>
    ...
    <script>
        ...
        // ==================== CHARGEMENT DES DONNÉES (modification) ====================
