...
<body>
    <div class="container">
        ...
        <!-- Formulaire pour la modification de publication -->
        <form id="updatePublicationForm">
            <input type="hidden" id="publication_id" name="id">
            ...
            <select id="massif" name="massif" required></select><br>

            <button type="submit">Mettre à jour la publication</button>
        </form>
    </div>
    <script src="js/modif_pub_user.js"></script>
</body>
