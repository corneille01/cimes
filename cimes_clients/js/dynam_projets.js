...
// Charge tous les projets de l'utilisateur depuis l'API
function chargerTousProjets() {
    ...
    fetch(`${API_URL}?query=projet`)
        ...
        .then(data => {
            ...
            // Récupère tous les massifs pour le filtre
            massifsSet.clear();
    ...
    projets.forEach(p => {
        html += `
            <tr>
                ...
                <td><a href="user_modif_projet.php?id=${p.id}" class="editer-lien"><i class="fas fa-pen"></i></a></td>
