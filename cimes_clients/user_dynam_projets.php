...
<body>
    <div class="dynam-wrapper">
        <div class="dynam-toolbar">
            <a href="dashboard.php" class="bouton_retour"><i class="fas fa-arrow-left"></i> Retour</a>
            <a href="user_ajout_projet.php" class="bouton_ajouter"><i class="fas fa-plus"></i> Ajouter un projet</a>
        </div>
    ...
    <script src="js/dynam_projets.js">
